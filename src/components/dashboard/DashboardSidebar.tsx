...
const DashboardSidebar = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className={`p-3 transition-all duration-300 ${isSidebarOpen ? "px-6" : "px-3"} pt-6`}
        >
          {/* Toggle Button */}
          <div
            className={`flex items-center justify-between mb-6 ${!isSidebarOpen ? "justify-center" : ""}`}
          >
            {isSidebarOpen && (
          ...
          <nav className="space-y-2">
            {sidebarItems.map((item) => {
              ...
              return (
                ...
                >
                  <span
                    className={`${isActive ? "text-blue-700" : "text-gray-400"} transition-colors duration-200`}
                  >
                    {item.icon}
                  </span>
                  {isSidebarOpen && (
