...
import { Data, PlantData, SoilData } from "@/types/api";
...
const RecommendationChatbotModal: FC<RecommendationChatbotModalProps> = ({
  ...
  const getInitialPrompt = () => {
    ...
    if ("disease_status" in data) {
      return `My plant has ${(data as PlantData).disease_status}. What should I do?`;
    }
    if ("ph" in data) {
      return `My soil has a pH of ${(data as SoilData).ph}. What does this mean and what should I do?`;
    }
